...
public class TodoController {
    ...
    @GetMapping
    public ApiResponse<PagedModel<EntityModel<Todo>>> findAll(Pageable pageable, PagedResourcesAssembler<Todo> assembler) {
    ...
    private EntityModel<Todo> toEntityModel(Todo todo) {
        return EntityModel.of(todo,
                ...
                linkTo(methodOn(TodoController.class).findAll(null, null))
                        .withRel(relFor(Todo.class)));
    }
